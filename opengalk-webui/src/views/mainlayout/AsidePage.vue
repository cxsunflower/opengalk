<template>
  <el-menu
      ...
      router
  >
    <el-button id="toggle-button" text :icon="arrow as string" @click="handleCollapse"/>
    ...
    <el-menu-item index="/paperManagement" v-show="showZero">
      <el-icon>
        <DocumentCopy/>
      </el-icon>
    ...
    <el-menu-item index="/userManagement" v-show="showZero">
      <el-icon>
        <Avatar/>
      </el-icon>
    ...
    <el-menu-item index="/collegeManagement" v-show="showZero">
      <el-icon>
        <School/>
      </el-icon>
    ...
    <el-menu-item @click="toLogout" index="">
      <el-icon>
        <Back/>
      </el-icon>
  ...
  <el-dialog title="退出提示" v-model="logoutDialogVisible" width="30%" @close="cancel" center align-center>
...
import {Avatar, Expand, Fold, LocationInformation, School, Setting,Document,DocumentCopy,Back,} from "@element-plus/icons-vue";
